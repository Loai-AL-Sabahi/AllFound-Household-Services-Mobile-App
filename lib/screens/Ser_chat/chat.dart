...
class Chat extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ServChatScreen();
  }
}

class ServChatScreen extends StatefulWidget {
  const ServChatScreen({Key? key}) : super(key: key);

  @override
  State<ServChatScreen> createState() => _ChatScreenState();
}

class _ChatScreenState extends State<ServChatScreen> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
